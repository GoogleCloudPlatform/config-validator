...
type Constraint struct {
	...
	// FullConfig contains the full constraint configuration object.
	// This is useful for displaying the exact rule that triggered a violation.
	FullConfig           *_struct.Value `protobuf:"bytes,6,opt,name=full_config,json=fullConfig,proto3" json:"full_config,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *Constraint) GetFullConfig() *_struct.Value {
	if m != nil {
		return m.FullConfig
	}
	return nil
...
var fileDescriptor_bf1c6ec7c0d80dd5 = []byte{
	...
	,
}
